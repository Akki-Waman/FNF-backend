...
public class ClientExcelGenerator {
    ...
    public static void generateExcel(List<ClientResponseDto> clients,
        ...
        titleCell.setCellValue("Clients List");
        ...
        String[] headers = {"Client ID", "Client Code", "Client Name"};
        ...
        for (ClientResponseDto c : clients) {
            ...
            row.createCell(1).setCellValue(c.getClientCode());
            row.createCell(2).setCellValue(c.getClientName());
