...
public class WorkflowNotificationExcelGenerator {
    ...
    public static void generateExcel(
        ...
        response.setHeader(
                "Content-Disposition",
                "attachment; filename=workflow_notifications.xlsx");

        Workbook workbook = new XSSFWorkbook();
        Sheet sheet = workbook.createSheet("Workflow Notifications");
        ...
        for (WorkflowNotificationDTO dto : notifications) {
            ...
            c1.setCellValue(dto.getStatus());
            c1.setCellStyle(dataStyle);

            Cell c2 = row.createCell(2);
            c2.setCellValue(dto.getNotificationType());
