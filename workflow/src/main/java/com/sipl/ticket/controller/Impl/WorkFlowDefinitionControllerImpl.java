...
public class WorkFlowDefinitionControllerImpl implements WorkFlowDefinitionController {
    ...
    @Override
    public ResponseEntity<Void> exportWorkFlowDefinitionCsv(
            WorkFlowDefinitionSearchRequestDTO request,
            HttpServletResponse response) {

        log.info("<<Start>> exportWorkflowsCsv <<Start>>");

        workFlowDefinitionService.exportWorkFlowDefinitionCsv(request, response);

        log.info("<<End>> exportWorkflowsCsv endpoint called <<End>>");
